programa
{
	...
	//Ajudantes
  	inteiro cooldown_jeff = 0
  	inteiro cooldown_Julio = 0
	cadeia escolhido = ""
	cadeia sequestrado = ""
	...
	funcao jogo()
	{
		...
		u.aguarde(4000)
		escreva("Omar: professor, você sabe onde tá todo mundo? \n")    
		u.aguarde(4000)
		...
		se (opcao == 1) {
			se (energia_jeff < energia_max e energia_jeff >=0) {
				se (inimigo == "Franco"){
					...
					round = "Franco"
				} senao se (escolhido == "Omar" e inimigo == "Julio") {
					se (cooldown_jeff == 0) {
						energia_jeff = energia_jeff + 40
						dano_jeff = 15
						...
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
						escreva("Omar jogou um pino em Julio, o dano foi de ", dano_jeff, " e a vida do Julio agora é ", vida_Julio, "\n")
						...
						cooldown_jeff = 3
						round = "Julio"
					} senao se (cooldown_jeff == 3) {
						escreva("Cooldown = ", cooldown_jeff, ". Espere mais ", cooldown_jeff, " rounds para que Omar ataque novamente!\n")
						energia_jeff = energia_jeff + 40 
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
						...
						round = "Julio"
						cooldown_jeff = cooldown_jeff - 1
					}
				} senao se (escolhido == "Eduardo" e inimigo == "Julio") {
					se (cooldown_jeff == 0) {
						vida_jeff = vida_jeff + 30
						energia_jeff = energia_jeff + 40
						...
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
						escreva("Eduardo recuperou 30 de vida de Jefferson! A vida do Jefferson agora é ", vida_jeff, "\n")
						...
						energia_jeff = energia_jeff + 40
						escreva("Cooldown = ", cooldown_jeff, ". Espere mais ", cooldown_jeff, " rounds para que Eduardo recupere a vida de jefferson novamente!\n")
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
				...
				} senao se (escolhido == "Victor" e inimigo == "Julio") {
					se (cooldown_jeff == 0) {
						energia_jeff = energia_jeff + 40
						dano_jeff = 20
						vida_Julio = vida_Julio - dano_jeff
						...
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
						escreva("Victor chutou Julio, o dano foi de ", dano_jeff, " e a vida do Julio agora é ", vida_Julio, "\n")
						...
						energia_jeff = energia_jeff + 40 
						escreva("Cooldown = ", cooldown_jeff, ". Espere mais ", cooldown_jeff, " rounds para que Victor ataque novamente!\n")
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
			...
			se (energia_Julio < energia_max e energia_Julio >= 0) {
				se (sequestrado == "") {
					...
					se (cooldown_Julio == 0) {
						...
						escreva("Energia de Julio recarregada!\n")
						escreva("Omar jogou um pino em Jefferson, o dano foi de ", dano_Julio, " e a vida do Jefferson agora é ", vida_jeff, "\n")
						...
						round = "Jefferson"
						cooldown_Julio = cooldown_Julio - 1
					}
					...
					se (cooldown_Julio == 0) {
						...
						escreva("Energia de Julio recarregada!\n")
						escreva("Victor chutou Jefferson! O dano causado foi de ", dano_Julio, " e a vida do Jefferson agora é ", vida_jeff, "\n")
					...
					se (cooldown_Julio == 0) {
						...
						escreva("Energia de Julio recarregada!\n")
						escreva("Eduardo recuperou 35 de vida de Julio! A vida do Julio agora é ", vida_jeff, "\n")
 ...
 * 
 * @POSICAO-CURSOR = 590; 
 * @DOBRAMENTO-CODIGO = [37, 89, 731, 1021, 1228, 1313, 1340];
 * @PONTOS-DE-PARADA = ;
