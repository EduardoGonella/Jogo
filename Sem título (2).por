      ...
      amigo_dois = "Omar"
        ...
        se(parceiro == "Eduardo")
          ...
          se(opcao == 1){
            ...
            //Quando Franco estiver com 5 ou menos de vida continua
            ...
            u.aguarde(4000) 
            escreva("Já ", sequestrado, " é tomado por uma sensação mentirosa de culpa, por ver o companheiro morrer em seu lugar. Por sorte, não é atingido pelo cheiro do extrato visto que suas vias áreas estavam cobertas com o pano. \n")
            u.aguarde(10000)
            limpa() 
            ...
            u.aguarde(4000)
            escreva("Franco então queima todo resto do extrato da babosa, fazendo uma enorme cortina de fumaça sair. \n") 
            u.aguarde(4000)
            escreva("Jeff e ", escolhido, " após segundos tentando encontrar a saída em meio a fumaceira, encontram e recuam para o lado de fora da quadra para não serem atingidos pelo cheiro . Porém, ao lembrar de ", sequestrado, ", ", escolhido, " tenta entrar na fumaça, mas é puxado por Jeff. \n") 
            u.aguarde(4000)
            ...
            u.aguarde(4000)
            escreva("Franco então some na fumaça. \n")
            u.aguarde(8000)
            
            limpa()


            escreva(escolhido, " e Jeff correm de volta até " , sequestrado, " para tentar salvá-lo. \n")
            u.aguarde(4000)
            escreva("Mas perceberam que Franco ja havia sumido com ele. \n")
            u.aguarde(4000)
            escreva("Desesperados, eles correm até a saída do campus na esperança de encontrar Franco e " , sequestrado, " . \n")
            u.aguarde(4000)
            escreva("Ao chegarem lá, percebem que Franco apesar de mmuito machucado estava muito longe. \n")
            u.aguarde(4000)
            escreva(escolhido, ": vamos correr atrás dele, não será difícil alcançá-lo. \n")
            u.aguarde(4000)
            escreva("Jeff concorda, e então eles começam a correr atrás de Franco. \n")
            u.aguarde(8000)
          
          limpa()

          escreva("Durante a perseguição, Franco chega ao mini auditório, mas acaba não resistindo e morre. \n")
          u.aguarde(4000)
          escreva("Jeff: finalmente ele morreu, mas quem é aquele saindo de dentro do mini auditório? \n")
          u.aguarde(4000)
          escreva("Então eles veem Júlio pegando o " , sequestrado, " e o levando para dentro do mini auditório. \n")
          u.aguarde(4000)
          escreva("Jeff e " ,escolhido, " entram no mini auditório e veem algo inacreditável... todos os alunos do Instituto estavam lá junto de Júlio. \n")
          u.aguarde(4000)
          escreva("Júlio: então vocês realmente descobriram o meu plano, e ainda derrotaram o Franco... vocês merecem ser punidos. \n")
          u.aguarde(4000)
          escreva("Júlio então toca o pouco restante da flauta binária no ouvido de " , sequestrado, " o possuindo. \n")
          u.aguarde(4000)
          escreva("Jeff: mas por que você está fazendo isso Júlio? \n")
          u.aguarde(4000)
          escreva(escolhido, ": é verdade professor Júlio, você era um ótimo professor. \n")
          u.aguarde(4000)
          escreva("Júlio: eu era um ótimo professor? NINGUEM PRESTAVA ATENÇÃO NA MINHA AULA. \n")
          u.aguarde(4000)
          escreva("Júlio: e é por isso que agora eu vou controlar todo o campus e depois o mundo, só restam vocês para eu controlar todo o campus. \n")
          u.aguarde(8000)

          limpa()

          escreva("Júlio fala palavras em código shell script e " , escolhido, " e Jeff não entendem. \n")
          u.aguarde(4000)
          escreva("Júlio: por eu ter tocado o pouco restante do poder da flauta binária no ouvido de ", sequestrado, " ele agora está sob meu controle e o único jeito seria nos matar. \n")
          u.aguarde(5000)
          escreva("Júlio ataca ", escolhido, " de surpresa e então começa uma luta épica entre Júlio e ", sequestrado, " contra Jeff e ", escolhido, " . \n")
          u.aguarde(8000)
          
          limpa()

          // batalha de Jeff contra Júlio


          escreva("No final da batalha, Júlio morre e ", sequestrado, " f9ica atordoado. \n")
          u.aguarde(4000)
          ...
          u.aguarde(4000)
          escreva(escolhido, ": finalmente todos estão livres do controle dele, mas eles não estão acordando, professor tente destruir a flauta binária. \n")
          u.aguarde(4000)
          ...
          u.aguarde(4000)
          escreva("Pelo sacrifício de ", parceiro, " é levantada uma estátua em sua homenagem. \n")
          u.aguarde(4000)
          escreva(sequestrado, " também ganha seus créditos. Uma festa é feita em homenagem aos heróis e finalmente o mundo não esta mais ameaçado. \n")
          u.aguarde(8000)
