			...
			se (energia_jeff < energia_max e energia_jeff >=0) {
				se (inimigo == "Franco"){
					...
					se (cooldown == 0) {
						...
						energia_jeff = energia_jeff + 40
						escreva("Cooldown = ", cooldown, ". Espere mais ", cooldown, " rounds para que Eduardo recupere a vida de jefferson novamente!\n")
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
					...
					se (cooldown == 0) {
						...
						energia_jeff = energia_jeff + 40 
						escreva("Cooldown = ", cooldown, ". Espere mais ", cooldown, " rounds para que Victor ataque novamente!\n")
						escreva("Energia recarregada! Sua energia agora é igual a ", energia_jeff, "/", energia_max, "\n")
 ...
 * 
 * @POSICAO-CURSOR = 44553; 
 * @DOBRAMENTO-CODIGO = [38, 689, 920, 1066, 1151, 1178];
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {vida_jeff, 8, 9, 9}-{vida_Franco, 18, 9, 11}-{inimigo, 25, 8, 7};
