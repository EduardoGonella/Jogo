	...
	funcao franco_dano () 
	{
		...
		se (opcao == 2) {
			...
			se (ataque == 1) {
				...
				dano_Franco = ???
				energia_Franco = energia_Franco - ??
				
				escreva("Franco utilizou ?????!\n")
				escreva("Jefferson perdeu ", dano_Franco, " de vida e 5 de energia! Agora Jefferson tem ", vida_jeff, "/200 de vida e ", energia_jeff, " /100 de energia\n") 
